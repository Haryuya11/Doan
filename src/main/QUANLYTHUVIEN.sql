...
drop function ThongTinPhatSinhVien
select * from dbo.ThongTinPhatSinhVien('MS00000009,MS00000001')
        ...
        RETURN
            (
                ...
                SELECT
                    ...
                    BS.MABANS AS MaBanSao,
                    CASE
                        WHEN CT.TINHTRANG = 'Da lam mat' THEN N'Làm mất'
                        ELSE N'Trả'
                        END AS HoatDong,
...
exec TRATAILIEU'MS00000001', 'BS00500004', '2024-05-09'
----PROCEDURE
